...
typedef void (*xmpp_conn_handler)(xmpp_conn_t * const conn, 
  ...
  int xmpp_connect_client(xmpp_conn_t * const conn, const char * const altdomain, unsigned short altport,
                          xmpp_conn_handler callback, void * const userdata);
...
typedef int (*xmpp_handler)(xmpp_conn_t * const conn, xmpp_stanza_t * const stanza, void * const userdata);
  ...
  void xmpp_handler_add(xmpp_conn_t * const conn, xmpp_handler handler, const char * const ns,
                        const char * const name, const char * const type, void * const userdata);
